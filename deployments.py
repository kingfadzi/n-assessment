...
column_config = {
    'app_name': 'AppName',         # Replace with the actual column name in your CSV
    'lob': 'LOB',                  # Replace with the actual column name in your CSV
    'environment': 'Environment',  # Replace with the actual column name in your CSV
    'criticality': 'Criticality',  # Replace with the actual column name in your CSV
    'strategy': 'Strategy',        # Replace with the actual column name in your CSV
    'offering_status': 'OfferingStatus',  # Replace with the actual column name in your CSV
    'deployments': 'Deployments'   # Replace with the actual column name in your CSV
}
...
result = result[[column_config['lob'], 'Deployments', 'Total Apps', 'Prod Apps', 'UAT Apps', 'Dev Apps', 'Most Critical Prod App', 'Strategy', 'Criticality', 'OfferingStatus']]
