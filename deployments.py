...
prod_critical = df[df[column_config['environment']] == 'Prod'].sort_values([column_config['criticality'], column_config['strategy']], ascending=[True, True])
...
result = pd.merge(result, most_critical_prod[[column_config['lob'], column_config['app_name'], column_config['criticality'], column_config['strategy'], column_config['offering_status']]], on=column_config['lob'])
